...
In this plot, it is shown that "roll_belt" and "yaw_belt" are the first two most important predictors/variables in this model.  

```{r plot2}
# visualization of the whole training data with the first two most important variables as x, y axies.                                  
qplot(roll_belt, pitch_belt,main ="Plot of training data with predictors(roll_belt & yaw_belt)", data = imp_training, color = classe)
```
